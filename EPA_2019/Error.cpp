...
namespace Error
{
	...
	{ 
		...
		ERROR_ENTRY(127, "[Семантическая] Отсутствует точки с запятой в конце"),
		...
		ERROR_ENTRY(603, "[Синтаксическая] Ошибка в параметрах функции(Типы параметров должны быть str)"),
