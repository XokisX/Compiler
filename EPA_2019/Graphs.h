...
//
/*#define GRAPH_SHORTx8_LITERAL 2, \
	FST::NODE(9,FST::RELATION('0',1),FST::RELATION('o',1), \
				FST::RELATION('2',1),FST::RELATION('1',1), \
				FST::RELATION('4',1),FST::RELATION('3',1), \
				FST::RELATION('6',1),FST::RELATION('5',1), \
				FST::RELATION('7',1)), \
	FST::NODE(9,FST::RELATION('0',1),FST::RELATION('o',1), \
				FST::RELATION('2',1),FST::RELATION('1',1), \
				FST::RELATION('4',1),FST::RELATION('3',1), \
