...
namespace Error
{
	...
	{ 
		...
		ERROR_ENTRY(8, "[Синтаксическая] Ошибка в синтаксическом анализе. Неизвестное правило разбора! Сверьтесь с разрешёнными комбинациями цепочек!"),
		ERROR_ENTRY_NODEF(9),
		...
		ERROR_ENTRY(120 ,"[Семантическая] У функции Compare не подходящие тип данных у параметров"),
		ERROR_ENTRY(121, "[Семантическая] Ошибка с параметрами"),
		...
		ERROR_ENTRY(124, "[Лексическая] Не удалось разобрать слово"),
		ERROR_ENTRY_NODEF(125),
		ERROR_ENTRY(126, "[Семантическая] Отсутствует возвращение из функции"),
		ERROR_ENTRY(127, "[Семантическая] Не верный тип параметра (STRLEN)"),
		...
		ERROR_ENTRY(615, "[Семантическая] Параметр не определен (использование в Strlen невозможно!) "),
